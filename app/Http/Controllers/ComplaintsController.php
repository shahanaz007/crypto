...
class ComplaintsController extends Controller
{
    ...
    public function index()
    {
        ...
        $complaints = Complaint::where('user_id',$user_id)->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        $complaint->complaints = $request->complaint;
        $complaint->save();
        return redirect('complaint')->with('status','Complaint Added Successfully !');
    }

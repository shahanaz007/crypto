...
<html lang="en">
  ...
  <!-- Bootstrap-extend -->
  <link rel="stylesheet" href="{{asset('assets/back-end/css/bootstrap-extend.css')}}">
  
  <!-- theme style -->
  <link rel="stylesheet" href="{{asset('assets/back-end/css/master_style.css')}}">
  
  <!-- Crypto_Admin skins -->
  <link rel="stylesheet" href="{{asset('assets/back-end/css/skins/_all-skins.css')}}">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    &copy; 2022 <a href="https://www.multipurposethemes.com/">Swizmart</a>. All Rights Reserved.
  </footer>
...
<!-- ./wrapper -->
  ...
  <!-- jQuery 3 -->
  <script src="{{asset('assets/back-end/assets/vendor_components/jquery/dist/jquery.js')}}"></script>
  
  <!-- popper -->
  <script src="{{asset('assets/back-end/assets/vendor_components/popper/dist/popper.min.js')}}"></script>
  
  <!-- Bootstrap 4.0-->
  <script src="{{asset('assets/back-end/assets/vendor_components/bootstrap/dist/js/bootstrap.js')}}"></script>
  
  <!-- Slimscroll -->
  <script src="{{asset('assets/back-end/assets/vendor_components/jquery-slimscroll/jquery.slimscroll.js')}}"></script>
  
  <!-- FastClick -->
  <script src="{{asset('assets/back-end/assets/vendor_components/fastclick/lib/fastclick.js')}}"></script>
  ...
  <!-- webticker -->
  <script src="{{asset('assets/back-end/assets/vendor_components/Web-Ticker-master/jquery.webticker.min.js')}}"></script>
  
  <!-- EChartJS JavaScript -->
  <script src="{{asset('assets/back-end/assets/vendor_components/echarts-master/dist/echarts-en.min.js')}}"></script>
  <script src="{{asset('assets/back-end/assets/vendor_components/echarts-liquidfill-master/dist/echarts-liquidfill.min.js')}}"></script>
  
  <!-- This is data table -->
    <script src="{{asset('assets/back-end/assets/vendor_plugins/DataTables-1.10.15/media/js/jquery.dataTables.min.js')}}"></script>
  
  <!-- Sparkline -->
  <script src="{{asset('assets/back-end/assets/vendor_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
  
  <!-- Crypto_Admin App -->
  <script src="{{asset('assets/back-end/js/template.js')}}"></script>
  
  <!-- Crypto_Admin dashboard demo (This is only for demo purposes) -->
  <script src="{{asset('assets/back-end/js/pages/dashboard.js')}}"></script>
  <script src="{{asset('assets/back-end/js/pages/dashboard-chart.js')}}"></script>

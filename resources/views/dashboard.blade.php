...
@section('content')
 <section class="h-100vh position-relative z-1" data-overlay="5">
				...
				<div class="col-lg-6 col-12">
					<div class="mt-80">
						...
						<div class="d-flex gap-3 justify-content-start">
							...
							<a href="#" class="btn btn-outline btn-primary text-white">Login</a>
						</div>
						@endif
					</div>	
				</div>
				<div class="col-lg-6 col-12">					
					<div class="text-center">
						<div class="owl-carousel owl-theme owl-btn-1 banner-slide" data-nav-arrow="false" data-nav-dots="false" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
							<div class="item">
								<img src="{{asset('assets/front-end/images/front-end-img/b-1.png')}}" class="img-fluid" alt="" />
							</div>
							<div class="item">
								<img src="{{asset('assets/front-end/images/front-end-img/b-2.png')}}" class="img-fluid" alt="" />
							</div>
							<div class="item">
								<img src="{{asset('assets/front-end/images/front-end-img/b-3.png')}}" class="img-fluid" alt="" />
							</div>
						</div>						
					</div>
				</div>
			...
			<div class="row mt-30 align-items-center">
				...
				<div class="col-lg-6 col-12 d-lg-block d-none">
					<div class="browserMockup browserMockup--perspectiveRight ms-70 position-relative">
						...
						<span class="homeScreenshot  homeScreenshot--mmo" style="background-position-y: 0px;background: url(assets/front-end/images/front-end-img/homePreview-MMO.png"></span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="false" data-nav-dots="false" data-items="10" data-md-items="8" data-sm-items="6" data-xs-items="4" data-xx-items="3">
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-1.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-2.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-3.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-4.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-5.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-6.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-7.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-8.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-9.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-10.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-11.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-12.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-13.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-14.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-15.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-16.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-17.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-18.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-19.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
						<div class="item"><img src="{{asset('assets/front-end/images/front-end-img/unilogo/uni-20.png')}}" class="img-fluid my-15 rounded box-shadowed pull-up" alt="" ></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row mt-30 align-items-center">
				<div class="col-lg-6 col-12 d-lg-block d-none">
					<div class="browserMockup browserMockup--perspectiveLeft me-70 position-relative">
						...
						<span class="homeScreenshot  homeScreenshot--gcs" style="background-position-y: 0px; background: url(assets/front-end/images/front-end-img/homePreview-MMO2.png "></span>
					</div>
				</div>
				<div class="col-lg-6 col-12">
	...
	<section class="py-100 bg-img countnm-bx" data-aos="fade-up" style="background-image: url(assets/front-end/images/front-end-img/map.png); background-position: top center;">
		<div class="container">			
			<div class="row justify-content-center">
				...
				<div class="col-lg-6 col-12">
					<div class="pay-bx px-30">
						...
						<div class="d-flex gap-3 mb-50">
							<a href="#" class="btn btn-dark btn-outline"><img src="{{asset('assets/front-end/images/front-end-img/logo-visa.png')}}" class="max-w-50" alt="" /></a>
							<a href="#" class="btn btn-dark btn-outline"><img src="{{asset('assets/front-end/images/front-end-img/logo-mastercard.png')}}" class="max-w-50" alt="" /></a>
							<a href="#" class="btn btn-dark btn-outline"><img src="{{asset('assets/front-end/images/front-end-img/logo-bitcoin.png')}}" class="max-w-50" alt="" /></a>
							<a href="#" class="btn btn-dark btn-outline"><img src="{{asset('assets/front-end/images/front-end-img/logo-ethereum.png')}}" class="max-w-50" alt="" /></a>
						</div>

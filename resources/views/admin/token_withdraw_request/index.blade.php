...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Token Withdraw Requests') }}</div>
                ...
                <div class="card-body">
                   ...
                   <table class="table  table-striped">
                      ...
                      <td> @if($withdraw_request->status == '0')
                              <a href="{{url('token_withdraw_request/change_status',$withdraw_request->id)}}">  <button class="btn btn-success">Completed</button></a>

                              <a href="{{url('token_withdraw_request/reject',$withdraw_request->id)}}">  <button class="btn btn-danger">_Rejected_</button></a>
                            @endif
                      </td>  
                   	</tr>
                   	<?php $slno++; ?>
